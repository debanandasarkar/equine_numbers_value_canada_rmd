...
max_horses <- horse_pop %>% 
  ...
  summarize(Maximum = max(Value),
            Minimum = min(Value))
max_horses %>%
  kable(caption = "Table 1. Maximum and minimum number of horses for each province between 1940 - 1972")
```
...
Figure 2. Horse populations for `r max_horses$Province[1]` between 1940 - 1972.
